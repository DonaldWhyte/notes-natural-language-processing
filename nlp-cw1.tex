...
%TODO: split training and test data into 3/4 for training. Make sure to split it up evenly classes
%
%TODO: isolate splitting code into single function in cw1_base and use in all code
%
%TODO: mention explicitly that I'm using the code form the book (e.g. NOTE) , before she sent out the email about the other code. Still splitting by 3/4 but randomising. This is the case for QUESTION 1, 2, 3 AND 4
