...
Syntactic ambiguity results in \textbf{exponential explosion} (it follows the Catalan numbers), which means the number of possible different parses increases exponentially. This can cause serious issues for parsing -- if there's an exponential number of different parses, how can evaluatre all the different parses to find the right ne?
...
\paragraph{\textbf{NOTE: }} Notice how the POS tags that words can have (terminals) have probabilities too, such as $IN \rightarrow with$ having a probability of 1.

TODO: probabilistic  context free grammar example, with annotation
...
TODO: two parses of example sentence
...
TODO: in-place figure of two discuss trees
...
TODO: in-place figure of two keep trees
